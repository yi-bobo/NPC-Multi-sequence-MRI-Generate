...
class DiffusionUNetResnetBlock(nn.Module):
    def __init__(
        ...
        if self.up:
            from Model.Net.BDBM_CC_Net.up_sample import WrappedUpsample
            ...
            from Model.Net.BDBM_CC_Net.down_sample import DiffusionUnetDownsample
...
class ConditionalUNetResnetBlock(nn.Module):
    def __init__(
        self,
        spatial_dims: int,
        in_channels: int,
