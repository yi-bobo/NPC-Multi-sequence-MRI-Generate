...
def main():
    # 1️⃣ 加载配置
    config_path = "./Config/Comparative_experiment/Pix2Pix/T1C_T1.yaml"
    ...
    model_components = {'net_G': model.net_G.state_dict(), 'net_D': model.net_D.state_dict(), 'optimizer_G': model.optimizer_G.state_dict(), 'optimizer_D': model.optimizer_D.state_dict()}
