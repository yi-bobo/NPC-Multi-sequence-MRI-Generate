...
def validate_model(model, val_loader, epoch, opt, best_metrics, rank, use_ddp):
    ...
    with torch.no_grad():
        for data in val_loader:
            ...
            (_, _, _, _,mae_x0, ssim_x0, psnr_x0, mae_xT, ssim_xT, psnr_xT) = real_model.val(x_0, x_T, txt, img_con1, img_con2)
...
def main():
    config_path = "/data1/weiyibo/NPC-MRI/Code/NPC-Multi-sequence-MRI-Generate/Config/CPC_BM/T1_T1C_withoutcond.yaml"
